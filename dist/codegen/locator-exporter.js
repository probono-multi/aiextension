...
export function generateLocatorsFileContent(pageName, locators, opts = { language: "ts", format: "dictionary", includeComments: true }) {
    ...
    if (language === "ts") {
        ...
        if (format === "dictionary") {
            ...
            for (const e of entries) {
                ...
                lines.push(`  static readonly ${e.key} = { strategy: ${JSON.stringify(l.strategy)}, value: ${JSON.stringify(l.value)}, playwrightKind: ${JSON.stringify(l.playwrightKind)} };`);
            }
            lines.push(`}`);
        }
        return lines.join("\n");
...
export function writeLocatorsToFile(outFolder, pageName, locators, opts = { language: "ts", format: "dictionary", includeComments: true }) {
